                                    ...
                                    <S.Tr key={client.id}>
                                        <S.Td>
                                            <S.ClientInfo>
                                                ...
                                                <div>
                                                    ...
                                                    <p style={{ fontSize: '0.75rem', color: 'var(--color-gray-400)' }}>{client.company}</p>
                                                </div>
                                            </S.ClientInfo>
                                        </S.Td>
                                        ...
                                        <S.Td>
                                            <S.Actions>
                                                ...
                                                <S.ActionButton $danger onClick={() => handleDeleteClick(client)} title={t('common.actions.delete')}>
                                                    <Trash2 size={16} />
                                                </S.ActionButton>
                                            </S.Actions>
                                        </S.Td>
